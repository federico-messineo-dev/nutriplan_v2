          ...
          dangerouslySetInnerHTML={{
            __html: [
              ...
              `}`,
                ...
                // Test: can module scripts execute on this browser?
                `window.__moduleTest=0;`,
                `var ms=document.createElement('script');`,
                `ms.type='module';`,
                `ms.textContent='window.__moduleTest=1';`,
                `document.head.appendChild(ms);`,
                // Test: can classic async scripts load and execute?
                `window.__scriptTest=0;`,
                `var st=document.createElement('script');`,
                `st.src='/sw.js?'+Date.now();`, // small file from same origin
                ...
                `  e.textContent='SW=CLEARED | mod='+window.__moduleTest+' | scr='+window.__scriptTest+' | reg='+n+' | fiber='+f;`,
                `  e.style.background=f?'#2e7d32':n?'#b8862f':window.__scriptTest===1?'#b8862f':'#c84b31';`,
                `}`,
