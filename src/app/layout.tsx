        ...
        <script
          dangerouslySetInnerHTML={{
            __html: [
              ...
              "  if(!el) return;",
              "  var hasDataScript = !!document.getElementById('__NEXT_DATA__');",
              "  var hasNextData = typeof window.__NEXT_DATA__ !== 'undefined';",
              "  var hasReactRoot = !!(document.querySelector('#__next') || document.querySelector('[data-reactroot]'));",
              "  el.textContent = '3s | dataScript=' + hasDataScript + ' | winData=' + hasNextData + ' | reactRoot=' + hasReactRoot;",
              "  el.style.background = hasDataScript ? '#2e7d32' : '#c84b31';",
              "}",
