...
export const mockRecipes = [
  // PROT_ANIMAL_LEAN
  { id: "r_prot_01", trainerId: null, name: "Petto di pollo", category: "PROT_ANIMAL_LEAN", kcalPer100g: 165, proteinPer100g: 31, carbPer100g: 0, fatPer100g: 3.6, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO"]), allergens: JSON.stringify([]), instructions: null },
  { id: "r_prot_02", trainerId: null, name: "Tacchino affettato", category: "PROT_ANIMAL_LEAN", kcalPer100g: 99, proteinPer100g: 21, carbPer100g: 0, fatPer100g: 1.5, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO"]), allergens: JSON.stringify([]), instructions: null },
  ...
  { id: "r_prot_04", trainerId: null, name: "Manzo magro macinato", category: "PROT_ANIMAL_LEAN", kcalPer100g: 137, proteinPer100g: 21, carbPer100g: 0, fatPer100g: 5.5, dietTags: JSON.stringify(["ONNIVORO"]), allergens: JSON.stringify([]), instructions: null },
  ...
  { id: "r_fish_03", trainerId: null, name: "Orata", category: "FISH_LEAN", kcalPer100g: 100, proteinPer100g: 20, carbPer100g: 0, fatPer100g: 1.5, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO"]), allergens: JSON.stringify(["pesce"]), instructions: null },
  // EGGS
  { id: "r_egg_01", trainerId: null, name: "Albume d'uovo", category: "EGGS", kcalPer100g: 52, proteinPer100g: 11, carbPer100g: 0.7, fatPer100g: 0.2, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO"]), allergens: JSON.stringify(["uova"]), instructions: null },
  { id: "r_egg_02", trainerId: null, name: "Uovo intero", category: "EGGS", kcalPer100g: 155, proteinPer100g: 13, carbPer100g: 1.1, fatPer100g: 11, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO"]), allergens: JSON.stringify(["uova"]), instructions: null },
  // DAIRY
  { id: "r_dairy_01", trainerId: null, name: "Yogurt greco 0%", category: "DAIRY_PROTEIN", kcalPer100g: 59, proteinPer100g: 10, carbPer100g: 3.6, fatPer100g: 0.4, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO"]), allergens: JSON.stringify(["lattosio"]), instructions: null },
  ...
  // LEGUMES
  { id: "r_leg_01", trainerId: null, name: "Lenticchie secche", category: "LEGUMES", kcalPer100g: 116, proteinPer100g: 9, carbPer100g: 20, fatPer100g: 0.4, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify([]), instructions: null },
  { id: "r_leg_02", trainerId: null, name: "Ceci cotti", category: "LEGUMES", kcalPer100g: 139, proteinPer100g: 7.2, carbPer100g: 22, fatPer100g: 2.6, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify([]), instructions: null },
  // GRAINS
  { id: "r_grain_01", trainerId: null, name: "Riso basmati", category: "GRAINS_REFINED", kcalPer100g: 130, proteinPer100g: 2.7, carbPer100g: 28, fatPer100g: 0.3, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify([]), instructions: null },
  { id: "r_grain_02", trainerId: null, name: "Pasta di semola", category: "GRAINS_REFINED", kcalPer100g: 158, proteinPer100g: 5.8, carbPer100g: 30, fatPer100g: 0.9, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify(["glutine"]), instructions: null },
  { id: "r_grain_03", trainerId: null, name: "Avena in fiocchi", category: "GRAINS_WHOLE", kcalPer100g: 379, proteinPer100g: 13.5, carbPer100g: 63, fatPer100g: 7, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify(["glutine"]), instructions: null },
  { id: "r_grain_04", trainerId: null, name: "Pane integrale", category: "GRAINS_WHOLE", kcalPer100g: 247, proteinPer100g: 9, carbPer100g: 45, fatPer100g: 3.4, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify(["glutine"]), instructions: null },
  // TUBERS
  { id: "r_tub_01", trainerId: null, name: "Patate", category: "TUBERS", kcalPer100g: 77, proteinPer100g: 2, carbPer100g: 17, fatPer100g: 0.1, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify([]), instructions: null },
  { id: "r_tub_02", trainerId: null, name: "Patate dolci", category: "TUBERS", kcalPer100g: 86, proteinPer100g: 1.6, carbPer100g: 20, fatPer100g: 0.1, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify([]), instructions: null },
  // VEG
  { id: "r_veg_01", trainerId: null, name: "Spinaci", category: "VEG", kcalPer100g: 23, proteinPer100g: 2.9, carbPer100g: 3.6, fatPer100g: 0.4, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify([]), instructions: null },
  { id: "r_veg_02", trainerId: null, name: "Zucchine", category: "VEG", kcalPer100g: 17, proteinPer100g: 1.2, carbPer100g: 3.1, fatPer100g: 0.3, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify([]), instructions: null },
  { id: "r_veg_03", trainerId: null, name: "Broccoli", category: "VEG", kcalPer100g: 34, proteinPer100g: 2.8, carbPer100g: 7, fatPer100g: 0.4, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify([]), instructions: null },
  // FRUIT
  { id: "r_fruit_01", trainerId: null, name: "Banana", category: "FRUIT", kcalPer100g: 89, proteinPer100g: 1.1, carbPer100g: 23, fatPer100g: 0.3, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify([]), instructions: null },
  { id: "r_fruit_02", trainerId: null, name: "Mela", category: "FRUIT", kcalPer100g: 52, proteinPer100g: 0.3, carbPer100g: 14, fatPer100g: 0.2, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify([]), instructions: null },
  // NUTS
  ...
  { id: "r_fat_02", trainerId: null, name: "Avocado", category: "FATS", kcalPer100g: 160, proteinPer100g: 2, carbPer100g: 8.5, fatPer100g: 15, dietTags: JSON.stringify(["ONNIVORO","PESCETARIANO","VEGETARIANO","VEGANO"]), allergens: JSON.stringify([]), instructions: null },
];
